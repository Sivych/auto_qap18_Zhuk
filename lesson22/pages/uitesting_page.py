...
class UITestingPage(BasePage):
    ...
    #     return self.open_page(self.VISIBILITY_TEXT)
    ...
    def assert_that_checkboxes_selected2(self):
        self.assertions.assert_that_element_checked(self.CHECKBOX2)
        self.assertions.assert_that_element_is_not_selected(self.CHECKBOX1)

    def select_by_value_in_dropdown(self, selector):
    ...
    # проверка, что элемент видно именно на той странице
    ...
    def assert_that_element_is_visible_img(self):
        self.assertions.assert_that_element_is_visible(self.IMG)

    def send_file_in_form(self):
        self.upload_file(self.FILE,
                         '/Users/elenayanushevskaya/teachmeskills/auto_18/lesson22/pages/assert_elements_visible.png')
